...
try {
  ...
  $mail->Username   = 'infernoo-steel@yandex.ru'; // Логин на почте
  $mail->Password   = 'ghxanrerwtiaswuh'; // Пароль на почте
  $mail->SMTPSecure = 'ssl';
  $mail->Port       = 465;

  $mail->setFrom('infernoo-steel@yandex.ru', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

  // Получатель письма
  $mail->addAddress('infernoo-steel@yandex.ru');
